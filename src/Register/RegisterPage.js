...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.lastName && user.gender && user.username && user.password) {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.firstNagenderme ? ' has-error' : '')}>
                        <label htmlFor="Gender">Gender</label>
                       <label> <input type="radio" className="form-control" name="gender" value="male"  checked={this.state.selectedOption === "Male"} onChange={this.onValueChange}/>Male </label>
                        <label> <input type="radio" className="form-control" name="gender" value="female" checked={this.state.selectedOption === "Female"} onChange={this.onValueChange} />Female </label>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" value="india"  checked={this.state.selectedOption === "India"} onChange={this.onValueChange}>India</a>
